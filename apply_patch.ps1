...
$PatchFileName = 'SRW_GC_Korean_v1.0.0.xdelta'
$ExpectedSourceSha256 = 'AD4CB99FFB3C0383802A2AB87963F98BA417DFC5184ED3FE3DFE077DA02DB229'
$ExpectedFinalSha256 = '4B8B16CF643AA0A36D6F02E9264765063A59FBCE2396DAE5F1836F298FBA0166'
...
if ([string]::IsNullOrWhiteSpace($OutputIso)) {
    $ResolvedOutput = Join-Path $SourceItem.DirectoryName 'Super Robot Taisen GC_Korean_v1.0.0.iso'
} else {
