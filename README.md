...
최신 배포본은 [v1.0.0 릴리스](https://github.com/snake7594/srw-gc-korean-patch/releases/tag/v1.0.0)에서 받을 수 있습니다.
...
| 결과 SHA-256 | `4B8B16CF643AA0A36D6F02E9264765063A59FBCE2396DAE5F1836F298FBA0166` |
| xdelta 크기 | `109,683,357` 바이트 |
...
출력 경로를 생략하면 원본 ISO와 같은 폴더에 `Super Robot Taisen GC_Korean_v1.0.0.iso`가 만들어집니다. 스크립트는 패치 전 원본과 패치 후 결과의 SHA-256을 모두 검사합니다.
